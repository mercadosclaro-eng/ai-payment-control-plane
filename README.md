...
Varyntiq is the confirmed public product name. Older `payguard` repository, endpoint and registry identifiers remain temporarily for compatibility and will be migrated without breaking existing integrations.
